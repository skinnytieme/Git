    ...
    var methods = {
        ...
        updateClasses: function (_base, _options) {
            ...
            if (_noTabs != true) {
                ...
                _base.$tabs.each(function (index, item) {
                    ...
                    _tab.removeClass(zozo.classes.first)
            ...
            _base.$elem
                ...
                .removeClass(zozo.classes.contained)
            ...
            (_base.settings.contained === true) && _base.$elem.addClass(zozo.classes.contained);
        ...
        checkWidth: function (_base, _init, _options) {
            ...
            _base.$tabs.each(function (index) {
                var _itemTempWidth = $(this).outerWidth(true) * 1.09;
                (_isCompact) && (_itemTempWidth = (_itemTempWidth * 1.09));
                if (_init === true) {
            ...
            if (_base.settings.orientation === zozo.classes.orientations.horizontal) {
                ...
                if (_isHorizontalResponsive) {
                   _base.$tabs.each(function (index) {
                       ...
                       _item.removeClass(zozo.classes.left).removeClass(zozo.classes.right).removeClass(zozo.classes.firstCol).removeClass(zozo.classes.lastCol).removeClass(zozo.classes.firstRow).removeClass(zozo.classes.lastRow)
        ...
        switchResponsiveClasses:function (_base, _resp) {               
            ...
            if (_resp === true)
            {
                ...
                (_isTop === true) ? _base.$elem.removeClass(_oriPos).addClass(_topLeft) : _base.$elem.removeClass(_oriPos).addClass(_bLeft);
